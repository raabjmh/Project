...
<div class="row">
    <div class="col-sm-4">
    <a "#"><img src="img/customer feedback.png" width="350" height="200" alt="Gyms" ></a>
    </div>
    <div class="col-sm-4">
    <a "#"><img src="img/gym owner feedback2.png" width="350" height="200" alt="send feedback" ></a>
    </div>
    <div class="col-sm-4">
    <a href="reportreview.php"><img src="img/report reviwe.png" width="350" height="200" alt="search history" ></a>
    </div>
</div>
<br><br>
<div class="row">
    <div class="col-sm-6">
    <a href="newrequests.php"><img src="img/Requests Of Publishing Gym1.png" width="550" height="200" alt="search history" ></a>
    </div>
    <div class="col-sm-6">
    <a href="requestreview.php"><img src="img/verfiy reviews.png" width="500" height="200" alt="search history" ></a>
    </div>
