<?php
    ...
    $sql = "SELECT * FROM gyms WHERE owner='$myusername'";
...
<table class="table table-striped">
    ...
    <?php while($row1 = mysqli_fetch_array($result)):; ?>
      <tr>
        ...
        <td><?php if($row1['isActive']==0){echo "not yet";}else{echo "yes";} ?></td>
        <td> <a href="deletegym.php?id=<?php echo $row1['id'];?>">Delete</a></td>
        <td> <a href="updategym.php?id=<?php echo $row1['id'];?>">Update</a></td>
      </tr>
      <?php endwhile;?>
